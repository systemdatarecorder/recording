...
public class Reporter implements DocHandler {
  ...
  public void startDocument() {
    System.out.println("  start document"); // NOPMD
  }
  public void endDocument() {
    System.out.println("  end document"); // NOPMD
  }
  public void startElement(final String  elem, final Hashtable<String, String> hashTable) {
    System.out.println("    start elem: "+elem); // NOPMD
    Enumeration<String> e = hashTable.keys();
    while(e.hasMoreElements()) {
      String key = (String)e.nextElement();
      String val = (String)hashTable.get(key);
      System.out.println("      "+key+" = "+val); // NOPMD
    }
  }
  public void endElement(String elem) {
    System.out.println("    end elem: "+elem); // NOPMD
  }
  public void text(String text) {
    System.out.println("        text: "+text); // NOPMD
  }
