/**
 * 
 * Copyright 2010 System Data Recorder Ltd
 * 
...
public class DefaultRequestDirector implements RequestDirector {
    ...
    public HttpResponse execute(HttpHost target, HttpRequest request,
    	...
    	double staletime = 0;
    	double staleCheckStart=System.nanoTime();
        ...
        try {
            ...
            while (!done) {
                ...
                if (managedConn == null) {
                    ...
                    staleCheckStart = System.nanoTime();
               ...
               staletime = System.nanoTime() - staleCheckStart;
            ...
            response.setHeader("staletime", staletime +"");
