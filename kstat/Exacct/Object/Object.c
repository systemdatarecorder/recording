...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_type); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_type)
{
    dVAR; dXSARGS;
    if (items != 1)
...

	{
		...
		if (stash == Sun_Solaris_Exacct_Object_Item_stash ||
			...
			IV tmp = SvIV(sv);
			self = INT2PTR(xs_ea_object_t *, tmp);
		} else {
			croak("self is not of type Sun::Solaris::Exacct::Object");
		}
	}
;
#line 215 "Object.xs"
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_catalog); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_catalog)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_value); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_value)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_match_catalog); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_match_catalog)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object_DESTROY)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "self");
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object__Item_new); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object__Item_new)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "class, catalog, value");
    {
...
#line 730 "Object.c"
	...
	if (RETVAL == NULL) {
		...
		sv_bless(ST(0), Sun_Solaris_Exacct_Object_Item_stash);
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object__Group_new); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object__Group_new)
{
    dVAR; dXSARGS;
    if (items < 2)
       croak_xs_usage(cv,  "class, catalog, ...");
    {
	char *	class = (char *)SvPV_nolen(ST(0))
;
	SV *	catalog = ST(1)
...
#line 798 "Object.c"
	...
	if (RETVAL == NULL) {
		...
		sv_setiv(newSVrv(ST(0), NULL), PTR2IV(RETVAL));
		sv_bless(ST(0), Sun_Solaris_Exacct_Object_Group_stash);
		SvREADONLY_on(SvRV(ST(0)));
	}
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object__Group_as_hash); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object__Group_as_hash)
{
    dVAR; dXSARGS;
    dXSI32;
    if (items != 1)
...
#line 826 "Object.c"
...

	{
		...
		if (stash == Sun_Solaris_Exacct_Object_Item_stash ||
			...
			croak("self is not of type Sun::Solaris::Exacct::Object::Group");
		}
	}
;
#line 555 "Object.xs"
...
XS_EUPXS(XS_Sun__Solaris__Exacct__Object___Array_copy_xs_ea_objects); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Sun__Solaris__Exacct__Object___Array_copy_xs_ea_objects)
{
    dVAR; dXSARGS;
...
extern "C"
#endif
XS_EXTERNAL(boot_Sun__Solaris__Exacct__Object); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Sun__Solaris__Exacct__Object)
{
    dVAR; dXSARGS;
...

    {
        ...
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::type", XS_Sun__Solaris__Exacct__Object_type, file, "$");
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::catalog", XS_Sun__Solaris__Exacct__Object_catalog, file, "$");
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::value", XS_Sun__Solaris__Exacct__Object_value, file, "$");
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::match_catalog", XS_Sun__Solaris__Exacct__Object_match_catalog, file, "$$");
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::DESTROY", XS_Sun__Solaris__Exacct__Object_DESTROY, file, "$");
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::Item::new", XS_Sun__Solaris__Exacct__Object__Item_new, file, "$$$");
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::Group::new", XS_Sun__Solaris__Exacct__Object__Group_new, file, "$$;@");
        cv = newXSproto_portable("Sun::Solaris::Exacct::Object::Group::as_hash", XS_Sun__Solaris__Exacct__Object__Group_as_hash, file, "$");
        XSANY.any_i32 = 0;
        cv = newXSproto_portable("Sun::Solaris::Exacct::Object::Group::as_hashlist", XS_Sun__Solaris__Exacct__Object__Group_as_hash, file, "$");
        XSANY.any_i32 = 1;
        (void)newXSproto_portable("Sun::Solaris::Exacct::Object::_Array::copy_xs_ea_objects", XS_Sun__Solaris__Exacct__Object___Array_copy_xs_ea_objects, file, ";@");
    }
